...
\begin{enumerate}
	...
	Yielding p-value: 0.28
	\item Finally, interpreting this result by comparing it to our alpha level ($\alpha=0.05$.):\\
	Because 0.28 is greater than 0.05, we fail to reject the null hypothesis; we cannot say there is statistically significant evidence that this teacher's school's average IQ is above the national average school IQ.
\end{enumerate}
