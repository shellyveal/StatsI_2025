...
\indent * Note: "Spending" variable,  \texttt{difflog}, is the difference in log of spending between incumbent and challenger.
...
\noindent We are interested in knowing how the difference in campaign spending between incumbent and challenger affects the incumbent's vote share. 
	...
	\end{table} 
		...
		\item Write the prediction equation.\vspace{.5cm}
			\begin{center}
				\(\hat{Y} = \alpha_{1} + \beta_{1}X = 0.579 + 0.042X\) \\
				
				\vspace{.3cm}
				
				\(\widehat{\texttt{voteshare}} = 0.579 + 0.042\texttt{difflog}\)
			\end{center}
			\vspace{.25cm}
...
\noindent We are interested in knowing how the difference between incumbent and challenger's spending and the vote share of the presidential candidate of the incumbent's party are related.\\
	\begin{enumerate}
		...
		\item Write the prediction equation.\\
			\begin{center}
				\(\hat{Y} = \alpha_{2} + \beta_{2}X = 0.508 + 0.024X\) \\
				
				\vspace{.3cm}
				
				\(\widehat{\texttt{presvote}} = 0.508 + 0.024\texttt{difflog}\)
		\vspace{.25cm}
			\end{center}
				In R:\\
...
\noindent We are interested in knowing how the vote share of the presidential candidate of the incumbent's party is associated with the incumbent's electoral success.
	...
	\begin{enumerate}
		...
		\item Write the prediction equation.
			\begin{center}
		\(\hat{Y} = \alpha_{3} + \beta_{3}X = 0.441 + 0.388X\) \\
		
		\vspace{.3cm}
		
		\(\widehat{\texttt{voteshare}} = 0.441 + 0.388\texttt{presvote} \)
			\end{center}
		\vspace{.25cm}
...
\noindent The residuals from part (a) tell us how much of the variation in \texttt{voteshare} is $not$ explained by the difference in spending between incumbent and challenger. The residuals in part (b) tell us how much of the variation in \texttt{presvote} is $not$ explained by the difference in spending between incumbent and challenger in the district.
	...
	\end{table}
		...
		\item Write the prediction equation.
			\begin{center}
				\(\hat{Y} = \alpha_{4} + \beta_{4}X = -1.942\times10^{-18} + 0.388X\) \\
				
				\vspace{.3cm}
				
				\(\widehat{\texttt{residuals RL 1}} = -1.942\times10^{-18} + 0.388\texttt{residuals RL 2}\)
			\end{center}
		\vspace{.25cm}
...
\noindent What if the incumbent's vote share is affected by both the president's popularity and the difference in spending between incumbent and challenger? 
	\begin{enumerate}
		...
		\item Write the prediction equation.	\vspace{.1cm}
			\begin{center}
				\(\hat{Y} = \alpha_{5} + \beta_{difflog}X_{difflog} + \beta_{presvote}X+_{presvote} = 0.449 + 0.036X_{difflog} + 0.257X_{presvote}\) \\
				
				\vspace{.3cm}
				
				\(\widehat{\texttt{voteshare}} = 0.449 + 0.036\texttt{difflog} + 0.257\texttt{presvote}\)
			\end{center}
		\vspace{.25cm}
